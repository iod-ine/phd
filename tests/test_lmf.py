...
def point_cloud():
    ...
    Here is how it looks like (the numbers represent heights and the distances between
    neighboring points are 1):
...
def test_lmf_finds_correct_maxima(point_cloud):
    ...
    detected_maxima = local_maxima_filter(
        point_cloud,
        window_size=1,
        height_threshold=0,
    )
...
def test_lmf_rejects_non_numpy_input():
    """The function assumes its input is a Numpy array and rejects anything else."""
